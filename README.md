...
`pnpm schema:push` and `pnpm content:push` carry a change to a site that already
has content. How to run them in dev and in production, and how to wipe and reseed
a local database, are in [scripts/README.md](scripts/README.md).
