...
//
// `parse` reads the JSON that `vitest run --reporter=json` writes, which is the
// Jest-compatible shape: numTotalTests/numPassedTests at the top level and
// per-file assertionResults below.
